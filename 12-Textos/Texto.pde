...
void setup() {
  ...
  umbreon_rugido = minim.loadFile("assets/mp3/Grito_de_Umbreon.mp3", 1024); // Cargamos el archivo y definimos su calidad.
  // Por una convension se usa 1024 y hace alusion a la velocidad de muestro
  // Si quieren pueden investigar mas sobre este tema.

  //Tipografias
  roboto = createFont("assets/fonts/Roboto.ttf",32); //creamos nuestra tipografia 
  primas = createFont("assets/fonts/Primas.ttf",32);
